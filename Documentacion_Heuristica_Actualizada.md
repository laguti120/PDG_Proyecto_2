# ARCHIVADO: Documentación heurística

Este archivo fue archivado y movido a la carpeta `archive/` por solicitud del usuario.

Por favor, consulta `archive/Documentacion_Heuristica_Actualizada.md` para el contenido completo y la versión histórica.

Motivo: eliminación del modelo de optimización y hojas históricas de la herramienta activa.
